...
const MESSAGES: MessagesByLanguage = {
  en: {
    ...
    salesRailTitle: "Daily sales",
    salesAllDates: "All dates",
    salesCount: "{count} sales",
    salesTransactions: "Sales",
    salesSelectedDate: "Showing {date}",
    salesAllDatesSelected: "Showing all dates",
    salesDaySummary: "Day summary",
    salesPeriodSummary: "Period summary",
    salesCurrencyNote: "Currency totals are separate; unlike currencies are not combined.",
    ...
    settingsDesc: "Choose a language and manage connection status and backups.",
    cookieTitle: "Sign-in status",
    cookieDesc: "Check the official site sign-in information used to fetch PoE2 history.",
    cookieLoginInformation: "Official site sign-in information",
    cookieButtonRefresh: "Check again",
    cookieStatusOk: "Available",
    cookieStatusMissing: "Missing",
    backupTitle: "Backup & Restore",
    backupDesc: "Export/import settings, sales history, and purchase history.",
    backupExportTitle: "Create a backup",
    backupExportDesc: "Save settings, sales history, and purchase history in one file.",
    backupRestoreTitle: "Restore a backup",
  ...
  ja: {
    ...
    salesRailTitle: "日別販売",
    salesAllDates: "全期間",
    salesCount: "販売件数 {count}",
    salesTransactions: "販売件数",
    salesSelectedDate: "{date} の履歴を表示",
    salesAllDatesSelected: "全期間の履歴を表示",
    salesDaySummary: "この日の内訳",
    salesPeriodSummary: "期間内訳",
    salesCurrencyNote: "通貨ごとの合計です。異なる通貨は合算しません。",
    ...
    csvHeaderAmount: "個数",
    settingsTitle: "設定",
    settingsDesc: "言語、接続状態、バックアップを管理します。",
    cookieTitle: "ログイン状態",
    cookieDesc: "PoE2の履歴取得に必要な公式サイトのログイン情報を確認します。",
    cookieLoginInformation: "公式サイトのログイン情報",
    cookieButtonRefresh: "再確認",
    cookieStatusOk: "取得済み",
    cookieStatusMissing: "未取得",
    backupTitle: "バックアップ / 復元",
    backupDesc: "設定・販売履歴・購入履歴をエクスポート/インポートします。",
    backupExportTitle: "バックアップを作成",
    backupExportDesc: "設定・販売履歴・購入履歴を1つのファイルに保存します。",
    backupRestoreTitle: "バックアップを復元",
